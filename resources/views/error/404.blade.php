    ...
    <style>
        ...
        *:before {
        ...
        .bird-anim:nth-child(1) {
            -webkit-animation: bird1 10s linear infinite forwards;
            animation: bird1 10s linear infinite forwards;
        }

        .bird-anim:nth-child(2) {
            -webkit-animation: bird2 10s linear infinite forwards;
            animation: bird2 10s linear infinite forwards;
            -webkit-animation-delay: 3s;
            animation-delay: 3s;
            z-index: -1;
        }
        ...
        .bird-anim:nth-child(3) {
            -webkit-animation: bird3 10s linear infinite forwards;
            animation: bird3 10s linear infinite forwards;
            -webkit-animation-delay: 5s;
            animation-delay: 5s;
        }

        .bird-anim:nth-child(4) {
            -webkit-animation: bird4 10s linear infinite forwards;
            animation: bird4 10s linear infinite forwards;
            -webkit-animation-delay: 7s;
            animation-delay: 7s;
        }

        .bird-anim:nth-child(5) {
            -webkit-animation: bird5 10s linear infinite forwards;
            animation: bird5 10s linear infinite forwards;
            -webkit-animation-delay: 14s;
            animation-delay: 14s;
        }

        .bird-anim:nth-child(6) {
            -webkit-animation: bird6 10s linear infinite forwards;
            animation: bird6 10s linear infinite forwards;
